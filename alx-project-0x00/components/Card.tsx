...
// const Card: React.FC<CardProps> = ({ title, location, price, rating, imgSrc, isTopRated }) => {
//   return (
//     <div className="border rounded-lg shadow-md overflow-hidden">
//       <img src={imgSrc} alt={title} className="w-full h-48 object-cover" />
//       <div className="p-4">
//         <h2 className="text-xl font-semibold">{title}</h2>
//         {isTopRated && <span className="text-sm bg-green-200 text-green-800 px-2 py-1 rounded">Top Rated</span>}
//         <p>{location}</p>
//         <p>${price} / night</p>
//         <p>⭐ {rating}</p>
//       </div>
